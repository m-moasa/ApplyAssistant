...
})({"8x0zo":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "046ea72cfdc881df";
"use strict";
...
},{}],"57677":[function(require,module,exports) {
...
class proObject {
    ...
    createProjectList(projectsList) {
        if (projectsList == null) {
            projectsList = [];
            projectsList.push(new (0, _positionJs.position)("ML project", "pro. John Smith", "MIT", "20 june 2025", "AI", "Contact me"));
            projectsList.push(new (0, _positionJs.position)("IOT project", "pro. Fei-Fei whith", "Stanford", "13 march 2025", "CS", "for master students"));
            projectsList.push(new (0, _positionJs.position)("BIO project", "pro. Justin", "Berkeley", "11 Oct 2024", "CS", "PHD"));
            projectsList.push(new (0, _positionJs.position)("Mathmatic project", "pro. Mary ", "Waterloo", "1 Nov. 2024", "Math", "Need work experience"));
            projectsList.push(new (0, _positionJs.position)("Psychology project", "pro. Jack ", "Harvard", "18 june 2026", "Science", "At least 3 recommendation"));
            projectsList.push(new (0, _positionJs.position)("Physics project", "pro. Tess Smith", "Hostun", "16 April 2027", "Science", "Nedd research experience"));
            projectsList.push(new (0, _positionJs.position)("Network project", "pro. walter ", "MIT", "5 Feb. 2024", "CS", "Feel free to contact me"));
        // projectsList = [
        //       {
        //         name: "Project 111111111111",
        //         faculty: "Faculty 1",
        ...
        console.log(proObject.projectList1, "Hello world!");
    }
    addProject(project) {
        console.log(project);
    ...
    updateProject() {
        ...
        proObject.projectList1.forEach((project)=>{
...
},{"./position.js":"1RXuV"}],"1RXuV":[function(require,module,exports) {
class position {
    constructor(projectName, facultyName, university, deadline, fields, detail){
...
},{}]},["8x0zo","57677"], "57677", "parcelRequire9333")

//# sourceMappingURL=index.fdc881df.js.map
